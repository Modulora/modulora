/** Shared brand glyphs (X, Discord, GitHub). Single source for footer + auth. */
...
export function ShadcnIcon({ className }: { className?: string }) {
  return (
    <svg viewBox="0 0 256 256" fill="none" stroke="currentColor" strokeWidth={25} strokeLinecap="round" className={className} aria-hidden>
